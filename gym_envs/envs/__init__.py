...
register(
	id='CustomPendulumNormalPyBulletEnv-v0',
	entry_point='pybulletgym.envs.roboschool.envs.pendulum.pendulum_normal_env:PendulumNormalEnv',
	max_episode_steps=1000,
	reward_threshold=950.0,
	)

register(
	id='CustomPendulumCartPyBulletEnv-v0',
	entry_point='pybulletgym.envs.roboschool.envs.pendulum.pendulum_cart_env:PendulumCartEnv',
	max_episode_steps=1000,
	reward_threshold=950.0,
	)

register(
	id='CustomPendulumCartdoublePyBulletEnv-v0',
	entry_point='pybulletgym.envs.roboschool.envs.pendulum.pendulum_cartdouble_env:PendulumCartDoubleEnv',
	max_episode_steps=1000,
	reward_threshold=950.0,
	)
